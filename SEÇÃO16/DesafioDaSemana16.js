...
*/
  ...
  /* EXPLICAÇÃO: 
  - Criar uma variavel 
  - Utilizar o for, *UTILIZAR ESTRUTURA FUNCIONAL* 
  - For começa em 0, em quanto ela for menor que name.length, vai somar mais um a variavel 
...
*/
  console.log('\nMeus amigos:')
  var friends = ['Paulo', 'Marcos', 'Maria', 'Sandro', 'Felipe', 'José']
  var phrase = friends
