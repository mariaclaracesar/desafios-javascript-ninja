...
*/
  ...
  var maria = new Person('Maria', 'Clara', 18)
  var hud = new Person('Hudson', 'Duarte', 19)
...
*/
  ...
  console.log(hud.getFullName() + ' tem ' + hud.getAge() + ' anos')
...
*/
  ...
  console.log(
    hud.getFullName() + ' agora tem ' + hud.addAge(2).getAge() + ' anos.'
  )
  console.log(
